namespace System.Collections.Frugal
{
    ...
    public struct FrugalStructList<T>
    {
        ...
        public FrugalStructList(System.Collections.ICollection collection)
        {
        ...
        /// </summary>
        /// <param name="collection">The collection.</param>
        public FrugalStructList(System.Collections.Generic.ICollection<T> collection)
        {
            if (collection.Count > 6)
            {
                _listStore = new ArrayItemList<T>(collection);
