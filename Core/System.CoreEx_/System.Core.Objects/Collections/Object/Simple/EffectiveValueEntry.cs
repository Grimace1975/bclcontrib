namespace System.Collections.Object.Simple
{
    ...
    internal struct EffectiveValueEntry
    {
        ...
        private ValueSource.Full _source;
        ...
        internal EffectiveValueEntry(BaseProperty dp, ValueSource.Base valueSource)
        {
            _propertyIndex = (short)dp.GlobalIndex;
            _value = BaseProperty.UnsetValue;
            _source = (ValueSource.Full)valueSource;
        }
        /// <summary>
        /// Initializes a new instance of the <see cref="EffectiveValueEntry"/> struct.
        /// </summary>
        ...
        internal EffectiveValueEntry(BaseProperty dp, ValueSource.Full valueSource)
        {
            _propertyIndex = (short)dp.GlobalIndex;
            _value = BaseProperty.UnsetValue;
            _source = valueSource;
        ...
        {
            EffectiveValueEntry entry = new EffectiveValueEntry(dp, ValueSource.Base.Default);
            entry.Value = value;
            return entry;
        }
        ...
        {
            _source = (ValueSource.Full)((short)(_source & ValueSource.Full.ValueSourceMask));
            _value = value;
        ...
        internal ValueSource.Base BaseValueSourceInternal
        {
            get { return (ValueSource.Base)((short)(_source & ValueSource.Full.ValueSourceMask)); }
            set { _source = ((ValueSource.Full)((short)(_source & ~ValueSource.Full.ValueSourceMask))) | ((ValueSource.Full)value); }
        }
        ...
        {
            get { return ReadPrivateFlag(ValueSource.Full.IsDeferredReference); }
            set { WritePrivateFlag(ValueSource.Full.IsDeferredReference, value); }
        }
        ...
        {
            get { return ReadPrivateFlag(ValueSource.Full.IsExpression); }
            private set { WritePrivateFlag(ValueSource.Full.IsExpression, value); }
        }
        ...
        {
            get { return ReadPrivateFlag(ValueSource.Full.IsAnimated); }
            private set { WritePrivateFlag(ValueSource.Full.IsAnimated, value); }
        }
        ...
        {
            get { return ReadPrivateFlag(ValueSource.Full.IsCoerced); }
            private set { WritePrivateFlag(ValueSource.Full.IsCoerced, value); }
        }
        ...
        {
            get { return (((short)(_source & ValueSource.Full.ModifiersMask)) != 0); }
        }
        ...
        internal ValueSource.Full FullValueSource
        {
            get { return _source; }
        }
        ...
        {
            get { return ReadPrivateFlag(ValueSource.Full.HasExpressionMarker); }
            set { WritePrivateFlag(ValueSource.Full.HasExpressionMarker, value); }
        }
        ...
        internal object LocalValue
        {
            get
            {
                if (BaseValueSourceInternal != ValueSource.Base.Local)
                {
        ...
        private void WritePrivateFlag(ValueSource.Full bit, bool value)
        {
            if (value == true)
            {
                _source = (ValueSource.Full)((short)(_source | bit));
            }
            else
            {
                _source = (ValueSource.Full)((short)((short)_source & ((short)~bit)));
            }
        }
        ...
        /// <param name="bit">The bit.</param>
        /// <returns></returns>
        private bool ReadPrivateFlag(ValueSource.Full bit)
        {
